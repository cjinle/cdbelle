...
"http://www.w3.org/TR/html4/loose.dtd"><html><head><meta http-equiv="Content-Type" content="text/html; charset=utf-8"><title>管理系统</title><link rel='stylesheet' type='text/css' href='__PUBLIC__/Css/common.css'></head><body class="right-bg"><div class="top-bar">			→ 欢迎<span style="color:red;"><?php echo ($_SESSION["user_name"]); ?></span>, （<span style="color:;"><?php echo ($_SESSION["priv_name"]); ?></span>）进入会员管理系统
			<span class="back-to-index"><img src="__PUBLIC__/Images/home.gif" style="line-height:25px;"/><a href="__ROOT__/index.php?m=Index&a=main">返回主首页</a></span></div><!--// .top-bar--><div class="r-content"><div class="r-content-title">代理商添加</div><div class="r-content-main"><form action="__ROOT__/index.php?m=Agents&a=insert" method="POST"><table width="730" border="0" cellpadding="5" cellspacing="5" style="margin:20px 0 20px 50px;"><tr><td align="right"><span class="mark">*</span>地区：</td><td><select name="province" id="province"><option value="0">请选择</option><?php if(is_array($province_list)): foreach($province_list as $key=>$item): ?><option value="<?php echo ($item["region_id"]); ?>"><?php echo ($item["region_name"]); ?></option><?php endforeach; endif; ?></select><select name="city" id="city"><option value="0">请选择</option></select><select name="district" id="district"><option value="0">请选择</option></select>&nbsp;
						<span id="Required_Province" style="color:red;visibility:hidden;">请选择代理商所在地区</span></td></tr><tr><td align="right"><span class="mark">*</span>用户名：</td><td><input type="text" name="user_name" id="user_name" class="readonly" value="" readonly="readonly" />&nbsp;
						<span id="Required_UserName" style="color:red;visibility:visible">用户名在选择地区时自动生成</span></td></tr><tr><td align="right"><span class="mark">*</span>代理商名称：</td><td><input type="text" name="real_name" value="" />&nbsp;
					    <span id="Required_RealName" style="color:red;visibility:hidden;">代理商名称不能为空</span></td></tr><tr><td align="right">邮件：</td><td><input type="text" name="email" value="" /></td></tr><tr><td align="right">QQ：</td><td><input type="text" name="qq" value="" /></td></tr><tr><td align="right">联系电话：</td><td><input type="text" name="mobile_phone" value="" /></td></tr><tr><td align="right">地址：</td><td><input type="text" name="address" value="" /></td></tr><tr><td align="right"><span class="mark">*</span>密码：</td><td><input type="password" name="new_pwd" value="" />&nbsp;
	...
	$("form").submit(function(){
		...
		if ($("input[name='user_name']").val() == "") {
			$("#Required_UserName").html("请选择代理商所在地区");
