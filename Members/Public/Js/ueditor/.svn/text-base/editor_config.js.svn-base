...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,toolbars:[["Source","Bold","Italic","Underline","StrikeThrough","ForeColor","BackColor","JustifyLeft","JustifyCenter","JustifyRight","InsertImage","Undo","Redo","InsertUnorderedList","InsertOrderedList","Unlink","Link"]]
        //当鼠标放在工具栏上时显示的tooltip提示
        ,labelMap:{'source':'','bold':'','italic':'','underline':'','strikethrough':'','forecolor':'','backcolor':'','justifyleft':'','justifycenter':'','justifyright':'','insertimage':'','undo':'','redo':'','insertunorderedlist':'','insertorderedlist':'','unlink':'','link':''}
